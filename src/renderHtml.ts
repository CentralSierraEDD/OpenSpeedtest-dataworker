    ...
    <html lang="en">
      ...
      <body>
        <header>
          ...
          />
          <h1>🎉 Successfully connected csedd-dataworker to D1</h1>
        </header>
        <main>
          <p>Your D1 Database contains the following data:</p>
          <pre><code><span style="color: #0E838F">&gt; </span>SELECT * FROM user_provided_data LIMIT 10;<br>${content}</code></pre>
          <small class="blue">
